...
namespace {
Status CheckTFSpecializedBackendName(const BackendCmdlineConfigMap& config_map) {
...
Status BackendConfiguration(const BackendCmdlineConfig& config, 
...
Status BackendConfigurationParseStringToDouble(const std::string& str, 
                                               double* val) {
  try {
    *val = std::stod(str);
  }
...
Status BackendConfigurationParseStringToBool(const std::string& str, 
                                             bool* val) {
  try {
